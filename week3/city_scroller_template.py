...
#for i in range (100):
    ...
    def create_building(self, x_location):
        building1 = Building(x_location, random.randint(20,200), self.width, random.randint(50, 150), self.color)
    ...
    def draw_buildings(self):
        # self.list1[0].color = BLUE
        for building in self.list1:
            building.draw()
            print ("i rock")
        #building1.draw()
        # for each buildig in list1 draw it on the screen
        #self.builing.draw()
        """
    ...
    def move_buildings(self):
        ...
        if self.list1[0].x_point>0:
            ...
            building1= Building(x_location, self.base, self.width, random.randint(50, 150), self.color)
            self.list1.insert(0, building1)

        # new_buildind_location = self.list1[-1].x_point + self.list1 [0].width
        # self.create_building(new_buildind_location)
        """
    ...
    #         player.sprite.Sprite.__init__(self)
...
#build = Building(400, 20, 150, 60, BLUE)
